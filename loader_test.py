...
class BratsDataset(Dataset):
    def __init__(self,mode,classes=3,crop_dim=(64,64,64),dataset_path='./BraTs_data/'):
        self.mode = mode
        self.classes = classes
        self.crop_dim = crop_dim
        self.dataset_path = dataset_path
        self.full_vol_dim = (155,240,240)
...
dataset = BratsDataset(mode='train',classes=3,crop_dim=(64,64,64),dataset_path='/media/ri2raj/External HDD/Task01_BrainTumour/')
