...
parser.add_argument("-mp", "--ModelPath", type=str, default="../best_model_VoxelNet_BCE.pkl")
...
parser.add_argument("-m", "--model", type=str, default="DenseVoxNet", choices=("unet3d", "vnet","DenseVoxNet"))
